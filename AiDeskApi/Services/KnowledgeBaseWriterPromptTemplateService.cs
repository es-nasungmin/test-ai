    ...
    public class KnowledgeBaseWriterPromptTemplateService : IKnowledgeBaseWriterPromptTemplateService
    {
        ...
        private async Task<KnowledgeBaseWriterPromptTemplate> EnsureTemplateAsync()
        {
            ...
            if (entity != null)
            {
                ...
                changed |= NormalizeAndAssign(entity.SimilarQuestionSystemPrompt, DefaultSimilarQuestionSystemPrompt, value => entity.SimilarQuestionSystemPrompt = value);
                changed |= NormalizeAndAssign(entity.SimilarQuestionRulesPrompt, DefaultSimilarQuestionRulesPrompt, value => entity.SimilarQuestionRulesPrompt = value);
